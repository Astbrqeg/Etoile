...
export default function ToolsBrushes() {
    const [products, setList] = React.useState([]);


    const ProductsData = async () => {
        try {
            let request = await fetch("http://localhost:3001/Tools&Brushes");
        ...
        <>
            ...
            <div className="ProductsPageContainer">
                <div className="ProductsPageTop">
                    <HeaderImage img={require("../Home/group-of-zero-waste-makeup-brushes-royalty-free-image-1657467939.jpg")} />
                    <div>
