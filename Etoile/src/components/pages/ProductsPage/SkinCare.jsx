...
export default function SkinCare() {
    ...
    const ProductsData = async () => {
        try {
            let request = await fetch("http://localhost:3001/SkinCare");
        ...
        <>
            ...
            <div className="ProductsPageContainer">
                <div className="ProductsPageTop">
                    <HeaderImage img={require("../Home/how-to-choose-the-right-skincare-products-for-your-skin-typemobilehome.jpg")} />
                    <div>
